...
/// Kirchensteuersatz je nach Bundesland: 8 % in Bayern und Baden-Wuerttemberg, sonst 9 %.
enum Kirchensteuersatz: String, CaseIterable, Codable, Identifiable, Sendable {
    ...
    var bezeichnung: String {
        ...
        case .achtProzent: "8 % (Bayern, Baden-Wuerttemberg)"
        case .neunProzent: "9 % (uebrige Bundeslaender)"
        }
    }
}
...
enum Kirchensteuer {
    ...
    ///   ist stattdessen die Steuer unter Beruecksichtigung der Kinderfreibetraege anzusetzen;
